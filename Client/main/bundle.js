...
var Hex = exports.Hex = function () {
  function Hex(x, y, size) {
    ...
    this.path = d3.select('#board').append("path").attr("d", lineFunction(cornerPoints)).style("fill", this.fill());
...
},{"./gameProperties.js":3,"./point.js":9,"d3":1}],5:[function(require,module,exports){
"use strict";
...
},{"./hex.js":4,"./map.js":6,"./mapCreationAnimator.js":7,"./node.js":8,"d3":1,"jquery":2}],6:[function(require,module,exports){
"use strict";
    ...
    value: function addNodes(q, r, lastId) {
      ...
      for (var i = 0; i < 6; i++) {
        if (this.get(q, r).getNodeId(i) == -1) {
          ...
          var newNode = new _node.Node(this, corner.x, corner.y, this.nodeRadius, lastId);
          newNode.owner = 0;
...
},{"./gameProperties.js":3,"./hex.js":4,"./node.js":8}],7:[function(require,module,exports){
"use strict";
...
var Node = exports.Node = function () {
  ...
  function Node(map, x, y, radius, id) {
    ...
    this.graphic = d3.select("#board").append("circle").attr("cx", this.center.x).attr("cy", this.center.y).attr("r", this.radius).attr("stroke", "black").style("fill", this.fill()).on("click", function () {
      // update the color for this node
      console.log("Attempting to claim");
      if (self.map.canClaim(self.map.playerTurn, self.id)) self.map.claim(self.map.playerTurn, self.id);
    });
    this.label = "";
...
},{"./gameProperties.js":3,"./point.js":9,"d3":1}],9:[function(require,module,exports){
"use strict";
