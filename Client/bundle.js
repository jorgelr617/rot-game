...
var Hex = exports.Hex = function () {
	...
	_createClass(Hex, [{
		...
		key: "calcCorner",
		value: function calcCorner(i) {
			var degrees = 60 * i;
			var radians = Math.PI / 180 * degrees;
			return new _point.Point(this.center.x + this.hexRadius * Math.cos(radians), this.center.y + this.hexRadius * Math.sin(radians));
		}
	}, {
		key: "setCorners",
		...
		key: "getCorner",
		value: function getCorner(i) {
			return this.cornerPoints[i];
		}
	}, {
		key: "positionChildNodes",
		value: function positionChildNodes() {

			var cornerPoint1 = this.calcCorner(1);
...
var Map = exports.Map = function () {
	...
	_createClass(Map, [{
		...
		key: "calcNextColumnTopHexY",
		value: function calcNextColumnTopHexY(hexCounter) {
...
!function() {
  ...
  d3_selectionPrototype.hexRadius = function() {
    var n = 0;
  ...
  d3_selection_enterPrototype.hexRadius = d3_selectionPrototype.hexRadius;
  ...
  function d3_selection_on(type, listener, capture) {
    ...
    function onAdd() {
      ...
      onRemove.call(this);
      this.toggleClickClass(type, this[name] = l, l.$ = capture);
      l._ = listener;
    }
    function removeAll() {
  ...
  d3.layout.partition = function() {
    ...
    partition.hexRadius = function(x) {
      if (!arguments.length) return size;
      size = x;
      return partition;
    };
  ...
  d3_transitionPrototype.hexRadius = d3_selectionPrototype.hexRadius;
